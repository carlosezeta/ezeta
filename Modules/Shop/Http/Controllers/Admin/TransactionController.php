...
class TransactionController extends AdminBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.shop.transaction.index')
            ->withSuccess(trans('core::core.messages.resource created', ['name' => trans('shop::transactions.title.transactions')]));
    }
    ...
    public function update(Transaction $transaction, Request $request)
    {
        ...
        return redirect()->route('admin.shop.transaction.index')
            ->withSuccess(trans('core::core.messages.resource updated', ['name' => trans('shop::transactions.title.transactions')]));
    }
    ...
    public function destroy(Transaction $transaction)
    {
        ...
        return redirect()->route('admin.shop.transaction.index')
            ->withSuccess(trans('core::core.messages.resource deleted', ['name' => trans('shop::transactions.title.transactions')]));
    }
}
